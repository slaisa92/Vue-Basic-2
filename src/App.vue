...
<template>
	<div class="app">
		<Tweet
			:image="tweets[0].user.image"
			:name="tweets[0].user.name"
			:handle="tweets[0].user.handle"
			:message="tweets[0].message"
			:timestamp="tweets[0].timestamp"
		/>
		<Tweet
			:image="tweets[1].user.image"
			:name="tweets[1].user.name"
			:handle="tweets[1].user.handle"
			:message="tweets[1].message"
			:timestamp="tweets[1].timestamp"
		/>
		<Tweet
			:image="tweets[2].user.image"
			:name="tweets[2].user.name"
			:handle="tweets[2].user.handle"
			:message="tweets[2].message"
			:timestamp="tweets[2].timestamp"
		/>
	</div>
</template>
